...
/*
	public static void main(String[] args) {
		...
		VariableClean bo = null;
		VariableClean bo1 = null;
		VariableClean bo2 = null;
		
		KeyedPooledObjectFactory<String, VariableClean> keyFactory = new DocxTemplateProcessorPoolableFactory();
		GenericKeyedObjectPool<String, VariableClean> keyPool = new GenericKeyedObjectPool<String, VariableClean>(keyFactory);
		keyPool.setMaxTotalPerKey(1);
		keyPool.setMaxTotal(10);
